...
import { CreditCard, Lock, Mail, Phone, Shield, User } from "lucide-react"
...
import { type BookingFormData, fullBookingSchema } from "@/lib/validations"
				...
				<CardContent className="text-center space-y-4">
					...
					<div className="bg-muted p-4 rounded-lg">
						<p className="font-semibold">
							{primaryFlight.airline} {primaryFlight.flight_number}
						</p>
					...
					<div className="space-y-4">
						...
						<div className="flex justify-between items-center">
							<div>
								...
								<p className="text-sm text-muted-foreground">
									{new Date(primaryFlight.departure_time).toLocaleDateString()}{" "}
									at{" "}
							...
							<div className="text-right">
								<p className="text-2xl font-bold text-primary">
									{formatPrice(primaryFlight.price)}
								</p>
				...
				<CardContent>
					<form
						onSubmit={handleSubmit(
							paymentStep === "details" ? onSubmitDetails : onSubmitPayment,
						)}
					>
						{paymentStep === "details" && (
							<div className="space-y-4">
								...
								<div className="space-y-2">
									...
									{errors.fullname && (
										<InlineError
											message={errors.fullname.message || "Invalid name"}
										/>
									)}
								</div>
							...
							<div className="space-y-4">
								...
								<div className="space-y-2">
									...
									{errors.cardNumber && (
										<InlineError
											message={
												errors.cardNumber.message || "Invalid card number"
											}
										/>
									)}
								</div>
								...
								<div className="grid grid-cols-2 gap-4">
									...
									<div className="space-y-2">
										...
										{errors.expiryDate && (
											<InlineError
												message={
													errors.expiryDate.message || "Invalid expiry date"
												}
											/>
										)}
									</div>
									...
									<div className="space-y-2">
										...
										{errors.cvv && (
											<InlineError
												message={errors.cvv.message || "Invalid CVV"}
											/>
										)}
									</div>
								</div>
