...
export type RoundTripBookingStep = 'select_outbound' | 'select_return' | 'booking'
...
interface RoundTripBookingContextType extends RoundTripBookingState, RoundTripBookingActions {}

const RoundTripBookingContext = createContext<RoundTripBookingContextType | undefined>(undefined)

interface RoundTripBookingProviderProps {
  children: ReactNode
}

export function RoundTripBookingProvider({ children }: RoundTripBookingProviderProps) {
...
export function useRoundTripBooking() {
  ...
  if (context === undefined) {
    throw new Error('useRoundTripBooking must be used within a RoundTripBookingProvider')
  }
  return context
}
